...
public class networksList_Adapter  extends RecyclerView.Adapter<networksList_Adapter.Holder> {
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(com.example.mobilecheckdevice.R.layout.family_module , parent , false);
    ...
    class Holder extends RecyclerView.ViewHolder {
        ...
        public Holder(@NonNull View itemView) {
            super(itemView);
            Name = (TextView) itemView.findViewById(com.example.mobilecheckdevice.R.id.Tuya_familyModule_name);
        }
    }
}
