...
//                        }
    ...
    private void getRooms() {
        StringRequest re = new StringRequest(Request.Method.POST, getRoomsUrl, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Log.d("roomsAre" ,  getRoomsUrl+" "+MyApp.Device_Id+" "+response);
                            ...
                            if (snapshot.getValue() != null) {
                                if (Integer.parseInt(snapshot.getValue().toString()) == 0) {
                                    if (ROOMS.get(finalI).getPOWER_B() != null) {
                                        if (Boolean.parseBoolean(ROOMS.get(finalI).getPOWER_B().dps.get("1").toString())) {
                                        ...
                                        if (Boolean.parseBoolean(ROOMS.get(finalI).getPOWER_B().dps.get("2").toString())) {
