...
public class GatewayActivity extends AppCompatActivity {
   ...
   // private ActivityGatewayBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.mobilecheckdevice.R.layout.activity_gateway);
    ...
    private void initList(){
       ...
       // binding.rvGatewayList.setLayoutManager(new LinearLayoutManager(this));
        kk = (RecyclerView)findViewById(com.example.mobilecheckdevice.R.id.rv_gateway_list);
        LinearLayoutManager manager = new LinearLayoutManager(act,RecyclerView.VERTICAL,false);
        kk.setLayoutManager(manager);
    }

    private void initListener() {
        Button b = (Button) findViewById(com.example.mobilecheckdevice.R.id.btn_scan_gw);
