...
public class LockListAdapter extends  RecyclerView.Adapter<LockListAdapter.DeviceViewHolder>{
    ...
    public DeviceViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View mView = LayoutInflater.from(mContext).inflate(R.layout.room_unit, parent, false);
...
//        }
    ...
    class DeviceViewHolder extends RecyclerView.ViewHolder {
        ...
        {
            super(itemView);
            //t = (TextView)itemView.findViewById(com.example.hotelservicesstandalone.R.id.tv_lock_name) ;

            //b=(Button) itemView.findViewById(com.example.hotelservicesstandalone.R.id.lock_init);
        }
