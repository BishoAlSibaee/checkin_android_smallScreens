...
public class UserGatewayListAdapter extends  RecyclerView.Adapter<UserGatewayListAdapter.DeviceViewHolder>{
    ...
    public DeviceViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View mView = LayoutInflater.from(mContext).inflate(com.example.hotelservicesstandalone.R.layout.user_gateway_list_item, parent, false);
        return new DeviceViewHolder(mView);
    }

    @Override
    public void onBindViewHolder(final DeviceViewHolder _holder, final int position)
    {
    ...
    class DeviceViewHolder extends RecyclerView.ViewHolder
    {
        ...
        {
            super(itemView);
            name = (TextView)itemView.findViewById(com.example.hotelservicesstandalone.R.id.tv_gateway_name);
        }
