...
public class Tuya_Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(com.example.hotelservicesstandalone.R.layout.tuya__login);
    ...
    void setActivity()
    {
        ...
        Country = (EditText) findViewById(com.example.hotelservicesstandalone.R.id.Tuya_Login_countryCode);
        email = (EditText) findViewById(com.example.hotelservicesstandalone.R.id.Tuya_Login_email);
        password = (EditText) findViewById(com.example.hotelservicesstandalone.R.id.Tuya_Login_password);
        r = (RecyclerView) findViewById(com.example.hotelservicesstandalone.R.id.family_Recycler);
