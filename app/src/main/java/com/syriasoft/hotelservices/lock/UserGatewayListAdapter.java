...
public class UserGatewayListAdapter extends  RecyclerView.Adapter<UserGatewayListAdapter.DeviceViewHolder>{
    ...
    public DeviceViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View mView = LayoutInflater.from(mContext).inflate(com.syriasoft.hotelservices.R.layout.user_gateway_list_item, parent, false);
            ...
            public void onClick(View v)
            {
                try
                {
                    ...
                    d.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which)
                        {
                            LoadingDialog d = new LoadingDialog(_holder.itemView.getContext());
                            String url = LogIn.URL+"setLockGatewayName.php";
    ...
    class DeviceViewHolder extends RecyclerView.ViewHolder
    {
        ...
        {
            super(itemView);
            name = (TextView)itemView.findViewById(com.syriasoft.hotelservices.R.id.tv_gateway_name);
        }
