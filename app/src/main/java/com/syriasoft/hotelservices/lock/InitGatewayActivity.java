...
public class InitGatewayActivity extends AppCompatActivity {
   ...
   // private ActivityInitGatewayBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.syriasoft.hotelservices.R.layout.activity_init_gateway);
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, retrofit2.Response<String> response) {
                ...
                if (!TextUtils.isEmpty(json)) {
                    ...
                    else ToastMaker.MakeToast(error.errmsg,act);
                }
            }
    ...
    private void initListener() {
        Button b = (Button) findViewById(com.syriasoft.hotelservices.R.id.btn_init_gateway);
