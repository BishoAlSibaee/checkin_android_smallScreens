...
public class GatewayListAdapter extends  RecyclerView.Adapter<GatewayListAdapter.DeviceViewHolder>{
    ...
    public DeviceViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View mView = LayoutInflater.from(mContext).inflate(com.syriasoft.hotelservices.R.layout.gateway_scan_list_item, parent, false);
    ...
    public class DeviceViewHolder extends RecyclerView.ViewHolder {
       ...
       // GatewayScanListItemBinding itemBinding;
        ...
        public DeviceViewHolder(View itemView){
            ...
            t = (TextView) itemView.findViewById(com.syriasoft.hotelservices.R.id.tv_gateway_name);
        }
